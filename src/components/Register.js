...
class Register extends React.Component {
  ...
  validateInput = () => {
    if(this.state.username.length===0){
      ...
      message.error("Please enter username <6 and >32 characters");
      return false;
    }
    ...
    else if(this.state.password.length<6 || this.state.password.length>32){
      message.error("Please enter password <6 and >32 characters");
      return false;
    }
    else if(this.state.password != this.state.confirmPassword){
      message.error("Please enter same password as above");
      return false;
    }
    else {
      return true;
